require_relative 'ui'
require_relative 'rank' #chamando conteudo que é definido em outro arquivo, relative pois esta no mesmo diretorio e não precisa colocar .rb, pois o proprio ruby definira isso
...
def jogo_da_forca
  ...
  #laço principal do jogo
    loop do
      ...
      if le_rank[1].to_i < pontos_totais #se o jogador atual ultrapassar os pontos do anterior, será gravado no rank.txt
